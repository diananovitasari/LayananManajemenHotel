...
namespace Hotel_Management_System
{
    public partial class ReservationForm : Form
    {
        ...
        {
            //Untuk menampilkan room type dalam combobox
            ...
            //Untuk menampilkan Reservation list dalam DatagridView
            getReservTable();
        ...
        {
            // menampilkan room's number  tergantung room type
            // Menampilkan room status yang free
            try
            {
                int type = Convert.ToInt32(comboBox_roomType.SelectedValue.ToString());
                comboBox_roomNo.DataSource = reservation.roomByType(type);
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Date in tanggal harus sama atau > Tanggal hari ini
                // Date out tanggal di harus sama atau > Tanggal Date in
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    getReservTable();
                    MessageBox.Show("Delete Reservation Successfuly", "Deleted Reservation", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
