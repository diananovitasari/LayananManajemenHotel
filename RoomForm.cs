...
namespace Hotel_Management_System
{
    public partial class RoomForm : Form
    {
        ...
        private void RoomForm_Load(object sender, EventArgs e)
        {
            ...
            comboBox_roomType.DisplayMember = "Label"[TIPE ROOM];
            comboBox_roomType.ValueMember = "CategoryId"[ID ROOM];
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            int[MEMUNCULKAN NOMOR KAMAR DI PUTIH2] type = Convert.ToInt32(comboBox_roomType.SelectedValue.ToString());
